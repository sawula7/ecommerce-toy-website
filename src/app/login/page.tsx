    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10">
          ...
          {(oauthProviders.has("google") || oauthProviders.has("facebook")) && (
            <>
              <div className="flex flex-col gap-3 mb-6">
                {oauthProviders.has("google") && (
                  <button
                    onClick={() => handleOAuth("google")}
                    className="flex items-center justify-center gap-3 w-full border-2 border-gray-200 hover:border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-xl transition-all text-sm"
                  >
                ...
                {oauthProviders.has("facebook") && (
                  <button
                    onClick={() => handleOAuth("facebook")}
                    className="flex items-center justify-center gap-3 w-full bg-[#1877F2] hover:bg-[#166fe5] text-white font-semibold py-3 px-4 rounded-xl transition-all text-sm"
                  >
          ...
          <form onSubmit={handleEmailLogin} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-primary hover:text-primary-dk font-semibold">
                  Forgot password?
                </Link>
              </div>
              <input
